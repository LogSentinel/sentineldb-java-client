...
public class DatastoreApi {
    ...
    private com.squareup.okhttp.Call getRecordsByDatastoreCall(String datastoreId, String actor, Integer pageNumber, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/api/datastore/{datastoreId}/records".replaceAll("\\{format\\}","json")
    ...
    private com.squareup.okhttp.Call getUsersByDatastoreCall(String datastoreId, String actor, Integer pageNumber, Integer pageSize, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/datastore/{datastoreId}/users".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "datastoreId" + "\\}", apiClient.escapeString(datastoreId.toString()));
    ...
    private com.squareup.okhttp.Call listDatastoresCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/api/datastore/list".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<List<Datastore>> listDatastoresWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = listDatastoresCall(null, null);
